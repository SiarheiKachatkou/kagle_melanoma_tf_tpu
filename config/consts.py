...
path_hair_images = root/"data/melanoma_hairs" if is_local else Path("gs://kds-c1f8d68ed78af3bc82472db8c32ec9b3fe1a0dcf09e62c04e90e81fe" if is_kaggle else "gs://kochetkov_kaggle_melanoma/malanoma_hairs")
