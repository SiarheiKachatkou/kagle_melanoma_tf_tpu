...
work_dir_name = 'b4_focal_loss_768_old_datasets_fine_tune_fix_tpu3' #'b4_focal_loss_768_old_datasets_fine_tune'


CONFIG=config(lr_max=0.0002*8/red, lr_start=0.0002*8/red, lr_warm_up_epochs=0, lr_min=0.000005/red,lr_exp_decay=0.8, nfolds=1,
