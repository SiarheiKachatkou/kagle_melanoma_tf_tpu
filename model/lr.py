...
def get_lrfn_fine_tune(CONFIG):
    def lrfn(epoch):
        ...
        if epoch<CONFIG.epochs_fine_tune:
            ...
            lr = (CONFIG.lr_max - CONFIG.lr_min) * CONFIG.lr_exp_decay**(epoch - CONFIG.lr_warm_up_epochs - LR_SUSTAIN_EPOCHS-CONFIG.epochs_fine_tune) + CONFIG.lr_min
        return lr
    return lrfn
